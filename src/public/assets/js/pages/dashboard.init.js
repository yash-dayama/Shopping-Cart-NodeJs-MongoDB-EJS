    ...
    (t.prototype.save = function() {
        ...
        return "" == t ?
            ...
            (r(
                    ...
                    e +
                    '</i></div><div class="conversation-text"><div class="ctext-wrap"><i></i><p>' +
                    t +
                    "</p></div></div></li>"
                ).appendTo(".conversation-list"),
                this.$chatInput.focus(),
                this.$chatList.animate({ scrollTop: this.$chatList.prop("scrollHeight") },
                    1e3
                ), !0);
    }),
            ...
            r = {
                ...
                xaxis: {
                    ...
                    categories: (function(t, e) {
                        for (
                            var r = new Date(e, t, 1), o = [], a = 0; r.getMonth() === t && a < 15;
